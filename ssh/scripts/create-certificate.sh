...
SUBJECT="/C=US/ST=CA/L=LosAngeles/O=Development-Certificates/CN=localhost";
DAYS=1024;
...
'
  ...
  # local SUBJECT="/C=US/ST=CA/L=LosAngeles/O=Development-Certificates/CN=example.com"
  # local DAYS=1024
